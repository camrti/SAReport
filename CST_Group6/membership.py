...
def get_membership_rules(labels):
    """
...
def plot_membership_functions(x_values, labels, title : str, filename : str):
    """
    xvalues
        np array of values for x
    labels
        Labels for each membership function (3)
    title : str
        Plot title
    filename : str
        Filename for saving the file
    """
    rules = get_membership_rules(labels)
