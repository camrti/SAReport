...
\begin{tabular}{ | m{5cm} | m{5cm}| m{5cm} | } 
  ...
  \textbf{Level 1 SA requirements} & \textbf{Level 2 SA requirements}  & \textbf{Level 3 SA requirements}  \\ 
  \hline
  Number of active users &  & Preventing student dropout \\ 
  \hline
  Session length & Comparison between students session lengths & \\ 
  \hline
  Days spent on module & Comparison between students days spent on module & \\
  \hline
  Number of answers on the forum & Student interaction within the forum & \\ 
  \hline
...
\begin{tabular}{ | m{5cm} | m{5cm}| m{5cm} | } 
  ...
  \hline
  Used material & Percentage of usage of the different kinds of materials provided to the students & \\ 
  \hline
